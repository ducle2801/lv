module.exports = (app) => {
  ...
  app.put(
    "/api/manage/update_status/status=:status/iddg=:iddg",
    review.updateStatus
  );

  app.delete("/api/manage/review/delete/iddg=:iddg", review.deleteReview);
  app.get("/api/manage/danhgia/idsp=:idsp", review.getdanhgia);
};
