module.exports = (app) => {
  ...
  app.put(
    "/api/manage/deliver/get_invoice_status/idnv=:idnv",
    deliver.getInvoiceStatus
  );

  app.get(
    "/api/manage/deliver/one_invoice/idhdx=:idhdx",
    deliver.getOneInvoice
  );

  app.get("/api/manage/deliver/list_invoice", deliver.getAllInvoice);
  app.get("/api/manage/deliver/shipinvoice/idnv=:data", deliver.getPriceShip);
  app.get("/api/manage/delivier/getnameship", deliver.getnameShip);

  app.delete(
    "/api/manage/deliver/delete_invoice/idhdx=:idhdx",
    deliver.deleteInvoice
  );
};
