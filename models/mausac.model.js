...
Color.getColor = (idsp, result) => {
  mysql.query(
    `SELECT DISTINCT thuong_hieu.ten_th,thuong_hieu.id_th FROM thuong_hieu INNER JOIN san_pham ON san_pham.id_th = thuong_hieu.id_th  WHERE san_pham.id_sp='${idsp}'`,
